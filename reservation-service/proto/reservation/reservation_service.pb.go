...
var file_reservation_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x06, 0x67, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x1f, 0x0a, 0x0d, 0x52,
	...
	0x61, 0x67, 0x65, 0x32, 0x83, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74,
	...
	0x0e, 0x2e, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22,
	0x00, 0x12, 0x36, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x0e, 0x2e, 0x52, 0x65,
...
var file_reservation_service_proto_goTypes = []interface{}{
	...
	(*ReservationId)(nil),             // 1: ReservationId
	(*DeleteReservationResponse)(nil), // 2: DeleteReservationResponse
	(*timestamppb.Timestamp)(nil),     // 3: google.protobuf.Timestamp
}
var file_reservation_service_proto_depIdxs = []int32{
	3, // 0: CreateReservationRequest.startDate:type_name -> google.protobuf.Timestamp
	3, // 1: CreateReservationRequest.endDate:type_name -> google.protobuf.Timestamp
	0, // 2: ReservationService.Create:input_type -> CreateReservationRequest
	1, // 3: ReservationService.Delete:input_type -> ReservationId
	1, // 4: ReservationService.Create:output_type -> ReservationId
	2, // 5: ReservationService.Delete:output_type -> DeleteReservationResponse
